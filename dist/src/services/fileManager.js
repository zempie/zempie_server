...
class FileManager {
    constructor() {
        this.uploadImage = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                // const { user } = req;
                const { fields, files } = yield this.formidable(req, 500, 500);
                req.params = Object.assign(Object.assign({}, req.params), fields);
                req.files = files;
                next();
            }
            catch (e) {
                (0, _convert_1.responseError)(res, e);
            }
        });
        this.uploadImage2 = (maxFileSizeMB = 100, maxFieldsSizeMB = 20) => {
            return this.uploadFiles(maxFileSizeMB, maxFieldsSizeMB);
        };
        this.uploadFiles = (maxFileSizeMB = 100, maxFieldsSizeMB = 20) => {
            return (req, res, next) => __awaiter(this, void 0, void 0, function* () {
                try {
                    const { err, fields, files } = yield this.formidable(req, maxFileSizeMB, maxFieldsSizeMB);
                    if (err) {
                        if (err.message.includes('maxFileSize')) {
                            (0, _convert_1.responseError)(res, (0, errorCodes_1.CreateError)(errorCodes_1.ErrorCodes.MAX_FILE_SIZE_EXCEEDED));
                        }
                        else if (err.message.includes('maxFieldsSize')) {
                            (0, _convert_1.responseError)(res, (0, errorCodes_1.CreateError)(errorCodes_1.ErrorCodes.MAX_FIELDS_SIZE_EXCEEDED));
                        }
                    }
                    else {
                        req.params = Object.assign(Object.assign({}, req.params), fields);
        ...
        this.s3upload3 = ({ key, filePath, uid, bucket }) => {
            return new Promise((resolve, reject) => {
                const params = {
                    ...
                    Key: key,
                    // ACL: 'public-read',
                    ContentType: (0, utils_1.getContentType)(filePath),
