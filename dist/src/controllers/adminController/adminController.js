...
class AdminController {
    login(params, admin) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!record) {
                throw (0, errorCodes_1.CreateError)(errorCodes_1.ErrorCodes.INVALID_ADMIN_USERNAME);
            }
            if (!(0, utils_1.verifyPassword)(password, record.password)) {
                throw (0, errorCodes_1.CreateError)(errorCodes_1.ErrorCodes.INVALID_ADMIN_PASSWORD);
            }
            if (!record.activated) {
                throw (0, errorCodes_1.CreateError)(errorCodes_1.ErrorCodes.FORBIDDEN_ADMIN);
            }
            const access_token = (0, utils_1.signJWT)({
                is_admin: true,
                id: record.id,
                uid: record.uid,
            ...
            const refresh_token = (0, utils_1.signJWT)({
                is_admin: true,
                id: record.id,
                account: record.account,
                name: record.name,
    ...
    addAdmin({ account, name, password, level, sub_level }, { id, uid }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (admin.level < 10) {
                throw (0, errorCodes_1.CreateError)(errorCodes_1.ErrorCodes.INVALID_ADMIN_LEVEL);
            }
            level = _.toNumber(level);
            if (isNaN(level) || level >= 10 || level < 1) {
                throw (0, errorCodes_1.CreateError)(errorCodes_1.ErrorCodes.INVALID_ADMIN_PARAMS);
            }
            ...
            yield globals_1.dbs.Admin.model.create({
                ...
                level,
                sub_level,
                password: (0, utils_1.makePassword)(password),
            });
        });
    }
    updateAdmin({ id: target_id, name, password, level, sub_level, activated }, { id, level: order_level, sub_level: order_sub_level }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (id === target_id) {
                admin.password = password ? (0, utils_1.makePassword)(password) : admin.password;
