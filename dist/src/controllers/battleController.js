...
class BattleController {
    constructor() {
        ...
        this.gameStart = ({ battle_uid, battle_key }, user) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!battle) {
                throw (0, errorCodes_1.CreateError)(errorCodes_1.ErrorCodes.INVALID_BATTLE);
            }
            if (new Date(battle.end_at) < new Date()) {
                throw (0, errorCodes_1.CreateError)(errorCodes_1.ErrorCodes.BATTLE_OVER);
            }
            // battle.user_count += 1;
            // await battle.save({transaction});
            let decoded = battle_key && battle_key !== '' ? (0, utils_1.verifyJWT)(battle_key) : {
                user_uid: uniqid(),
                best_score: -1
            };
            ...
            const new_battle_key = (0, utils_1.signJWT)({
                uid: battle_uid,
        ...
        this.gameOver = ({ battle_key, score }, user) => __awaiter(this, void 0, void 0, function* () {
            const decoded = (0, utils_1.verifyJWT)(battle_key);
        ...
        this.updateUserName = ({ battle_key, name }, user) => __awaiter(this, void 0, void 0, function* () {
            // 불량 단어 색출
            if (!!name && !(yield globals_1.dbs.ForbiddenWords.isOk(name))) {
