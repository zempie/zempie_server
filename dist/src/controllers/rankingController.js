...
class RankingController {
    constructor() {
        this.getGlobalRanking = ({ game_id, limit = 50, offset = 0 }, { uid: user_uid }) => __awaiter(this, void 0, void 0, function* () {
            let score, rank;
            ...
            if (user_uid) {
                const gameRecord = yield globals_1.dbs.UserGame.findOne({ game_id, user_uid });
                if (gameRecord) {
