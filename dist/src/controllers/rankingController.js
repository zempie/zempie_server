...
class RankingController {
    constructor() {
        this.getGlobalRanking = ({ game_uid, limit = 50, offset = 0 }, { uid: user_uid }) => __awaiter(this, void 0, void 0, function* () {
            let score, rank;
            ...
            if (user_uid) {
                const gameRecord = yield globals_1.dbs.UserGame.findOne({ game_uid, user_uid });
                if (gameRecord) {
        ...
        this.getFollowingRanking = ({ game_uid, limit = 50, offset = 0 }, { uid: user_uid }, transaction) => __awaiter(this, void 0, void 0, function* () {
            let score, rank;
            const gameRecord = yield globals_1.dbs.UserGame.findOne({ game_uid, user_uid }, transaction);
            if (gameRecord) {
                score = gameRecord.score;
