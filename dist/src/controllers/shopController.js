...
class ShopController {
    buyItem({ item_id }, user) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!item) {
                throw errorCodes_1.CreateError(errorCodes_1.ErrorCodes.INVALID_ITEM_ID);
            }
            ...
            yield globals_1.dbs.Inventory.getTransaction((transaction) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (item.used_type !== enums_1.eItemUsingType.Accumulated) {
                    ...
                    if (_have_it) {
                        throw errorCodes_1.CreateError(errorCodes_1.ErrorCodes.BUY_DUPLICATED_ITEM);
                    }
                }
                // 돈 있나 확인
                // 구매 - 포인트 차감
    ...
    useItem({ item_id }, user) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield globals_1.dbs.Inventory.getTransaction((transaction) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (item.is_used) {
                    throw errorCodes_1.CreateError(errorCodes_1.ErrorCodes.REJECT_USE_ITEM);
                }
            }));
        });
    }
