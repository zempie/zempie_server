    ...
    constructor() {
        this.featuredList = () => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!ret) {
                ...
                const official = yield globals_1.dbs.Game.getListIncludingUser({ official: true, activated: true, enabled: true }, { order: sequelize_1.Sequelize.literal('rand()'), limit: 5 });
                const unofficial = yield globals_1.dbs.Game.getListIncludingUser({ official: false, activated: true, enabled: true }, { order: sequelize_1.Sequelize.literal('rand()'), limit: 5 });
                ret = [
                    {
                    ...
                    },
                    {
                        ...
                        games: _.map(official, obj => _common_1.getGameData(obj)),
                        key: 'official',
                    },
                    {
                        name: '도전 게임 Unofficial Games',
                        games: _.map(unofficial, obj => _common_1.getGameData(obj)),
                        key: 'unofficial',
                    },
                    {
        ...
        this.getGameList = ({ limit = 50, offset = 0, official, sort, dir }, user, { req }) => __awaiter(this, void 0, void 0, function* () {
            const query = JSON.stringify(req.query);
            let games = yield globals_1.caches.game.getList(query);
            if (!games) {
                const rows = yield globals_1.dbs.Game.getList({ limit, offset, official, sort, dir });
        ...
        this.tagTest = ({ title, hashtags }, user) => __awaiter(this, void 0, void 0, function* () {
