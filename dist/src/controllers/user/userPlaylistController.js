    ...
    constructor() {
        ...
        this.getPlaylist = ({ uid }, _user) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!ret) {
                ...
                if (!playlist) {
                    throw (0, errorCodes_1.CreateError)(errorCodes_1.ErrorCodes.INVALID_PLAYLIST_UID);
                }
                const indexes = JSON.parse(playlist.indexes);
                const indexedGames = [];
                _.forEach(indexes, (i) => {
                    const obj = _.find(playlist.games, (g) => g.game_id === i);
                    indexedGames.push((0, _common_1.getGameData)(obj.game));
                });
                const { user } = playlist;
                ret = {
                    uid: playlist.uid,
        ...
        this.addGame = ({ uid, game_id }, user) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield globals_1.dbs.UserPlaylist.getTransaction((transaction) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (i !== -1) {
                    throw (0, errorCodes_1.CreateError)(errorCodes_1.ErrorCodes.PLAYLIST_DUPLICATED_GAME);
                }
