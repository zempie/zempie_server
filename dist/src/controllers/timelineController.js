...
class TimelineController {
    ...
    doPosting({ type, score, follower_ids, game_id, user_id, achievement_id, battle_id }, user, transaction) {
        return __awaiter(this, void 0, void 0, function* () {
            const uid = uniqid();
            let extra;
            switch (type) {
    ...
    deletePosting({ uid }, user) {
        return __awaiter(this, void 0, void 0, function* () {
            return globals_1.dbs.Timeline.getTransaction((transaction) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (!posting) {
                    throw (0, errorCodes_1.CreateError)(errorCodes_1.ErrorCodes.INVALID_TIMELINE_USER_UID);
                }
