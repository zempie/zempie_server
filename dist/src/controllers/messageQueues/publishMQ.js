...
class PublishMQ extends _srvMQ_1.SrvMQ {
    gameOver(message) {
        return __awaiter(this, void 0, void 0, function* () {
            const { pid, game_uid, } = message;
            if (pid) {
                const pu = yield globals_1.dbs.User.findOne({ uid: pid });
                const game = yield globals_1.dbs.Game.findOne({ uid: game_uid });
    ...
    pub_PlayGame(message) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!game) {
                throw errorCodes_1.CreateError(errorCodes_1.ErrorCodes.INVALID_GAME_UID);
            }
            return globals_1.dbs.User.getTransaction((transaction) => __awaiter(this, void 0, void 0, function* () {
                ...
                yield globals_1.dbs.UserPublishing.updateCount({ user_id: user.id, game_id: game.id, type: 'open' }, transaction);
            }));
        });
    }
}
