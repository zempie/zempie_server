...
const communityRoute_1 = require("../routes/communityRoute");
const gameAuthRoute_1 = require("../routes/gameAuthRoute");
class ApiServer extends server_1.default {
    ...
    routes(app) {
        super.routes(app);
        (0, adminRoute_1.default)(app);
        (0, userRoute_1.default)(app);
        (0, contentRoute_1.default)(app);
        (0, gameRoute_1.default)(app);
        (0, launcherRoute_1.default)(app);
        (0, supportRoute_1.default)(app);
        (0, redirectRoute_1.default)(app);
        (0, communityRoute_1.default)(app);
        (0, gameAuthRoute_1.default)(app);
        // tcpRoute(app);
