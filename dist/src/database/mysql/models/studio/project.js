...
class ProjectModel extends model_1.default {
    ...
    create({ user_id, name, description, picture }, transaction) {
    ...
    updateProject({ id, name, picture, control_type, description, game_id, deploy_version_id, update_version_id }, transaction) {
        return __awaiter(this, void 0, void 0, function* () {
