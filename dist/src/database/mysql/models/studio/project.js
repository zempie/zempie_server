...
class ProjectModel extends model_1.default {
    ...
    create({ user_id, name, description, picture, picture2, hashtags }, transaction) {
    ...
    updateProject({ id, name, picture, picture2, control_type, description, hashtags, game_id, deploy_version_id, update_version_id }, transaction) {
        return __awaiter(this, void 0, void 0, function* () {
