...
exports.default = (router) => {
     ...
     * 금지어
     */
    router.get(`${apiVer}/admin/filter/forbidden-words`, _common_1.validateAdminIdToken, _convert_1.default(adminUserController_1.default.getForbiddenWord));
    router.post(`${apiVer}/admin/filter/forbidden-word/c`, _common_1.validateAdminIdToken, _convert_1.default(adminUserController_1.default.addForbiddenWord));
    router.post(`${apiVer}/admin/filter/forbidden-word/u`, _common_1.validateAdminIdToken, _convert_1.default(adminUserController_1.default.setForbiddenWord));
    router.post(`${apiVer}/admin/filter/forbidden-word/d`, _common_1.validateAdminIdToken, _convert_1.default(adminUserController_1.default.delForbiddenWord));
