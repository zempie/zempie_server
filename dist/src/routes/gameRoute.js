...
exports.default = (router) => {
    ...
    router.post(`${apiVer}/game/emotion`, _common_1.validateFirebaseIdToken, _common_1.isAuthenticated, _convert_1.default(gameContentController_1.default.emotion));
    // 게임 댓글
    router.get(`${apiVer}/game/reply`, _common_1.validateFirebaseIdToken, _convert_1.default(gameContentController_1.default.getReplies));
    router.get(`${apiVer}/game/rereply`, _common_1.validateFirebaseIdToken, _convert_1.default(gameContentController_1.default.getReReplies));
    router.post(`${apiVer}/game/reply`, _common_1.validateFirebaseIdToken, _common_1.isAuthenticated, _convert_1.default(gameContentController_1.default.leaveReply));
    router.post(`${apiVer}/game/reply/reaction`, _common_1.validateFirebaseIdToken, _common_1.isAuthenticated, _convert_1.default(gameContentController_1.default.reactReply));
    // 도전 게임 - 평가 리포트
    router.get(`${apiVer}/game/ch-report`, _common_1.validateFirebaseIdToken, _convert_1.default(gameContentController_1.default.getReports));
    router.post(`${apiVer}/game/ch-report`, _common_1.validateFirebaseIdToken, _common_1.isAuthenticated, _convert_1.default(gameContentController_1.default.createOrUpdateChallengingReport));
