...
exports.validateGameToken = exports.adminTracking = exports.checkUserDenied = exports.validateAdminIdToken = exports.validateFirebaseIdToken = exports.getIdToken = exports.isDeveloper = exports.isAuthenticated = exports.readyToPlay = exports.validateUid = exports.throwError = void 0;
...
const isAuthenticated = (req, res, next) => {
    if (!req.user) {
        return (0, _convert_1.responseError)(res, (0, errorCodes_1.CreateError)(errorCodes_1.ErrorCodes.UNAUTHORIZED), 401);
    }
    next();
};
...
const validateFirebaseIdToken = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const idToken = (0, exports.getIdToken)(req);
        if (idToken) {
...
const validateAdminIdToken = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const idToken = (0, exports.getIdToken)(req);
        req.user = yield (0, utils_1.verifyJWT)(idToken);
        return next();
    }
    catch (error) {
        return (0, _convert_1.responseError)(res, (0, errorCodes_1.CreateError)(errorCodes_1.ErrorCodes.UNAUTHORIZED), 401);
...
const checkUserDenied = (name) => {
    return (req, res, next) => {
        ...
        if (((_a = claim === null || claim === void 0 ? void 0 : claim.deny[name]) === null || _a === void 0 ? void 0 : _a.state) && claim.deny[name].date >= Date.now()) {
            return (0, _convert_1.responseError)(res, (0, errorCodes_1.CreateError)(errorCodes_1.ErrorCodes.ACCESS_DENY), 403);
...
//게임서버 유저 토큰 확인
const validateGameToken = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const token = req.query.token;
        const apiKey = (0, exports.getIdToken)(req);
        const isApiKeyValid = yield gameAuthController_1.default.verifyGameToken(apiKey);
        if (isApiKeyValid) {
            req.user = (yield gameAuthController_1.default.verifyToken({ token })).info;
            return next();
        }
        else {
            return (0, _convert_1.responseError)(res, (0, errorCodes_1.CreateError)(errorCodes_1.ErrorCodes.UNAUTHORIZED), 401);
...
exports.validateGameToken = validateGameToken;
