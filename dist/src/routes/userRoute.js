...
exports.default = (router) => {
    ...
    router.get(`${apiVer}/user/mails`, _common_1.validateFirebaseIdToken, _common_1.isAuthenticated, _convert_1.default(userContentController_1.default.getMailbox));
    router.get(`${apiVer}/user/mail/:id`, _common_1.validateFirebaseIdToken, _common_1.isAuthenticated, _convert_1.default(userContentController_1.default.readMail));
    router.post(`${apiVer}/user/mail/d`, _common_1.validateFirebaseIdToken, _common_1.isAuthenticated, _convert_1.default(userContentController_1.default.deleteMail));
