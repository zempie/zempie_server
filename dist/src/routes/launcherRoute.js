...
exports.default = (router) => {
    // 게임 실행
    router.get(`${apiVer}/launch/game/:pathname`, _convert_1.default(launcherController_1.default.getGame));
    ...
    router.get(`${apiVer}/launch/game-ranking/:game_id`, _common_1.validateFirebaseIdToken, _convert_1.default(rankingController_1.default.getGlobalRanking));
    // 배틀
